...
<body>
    <div class="container">
        <header>
            <h1><span class="material-symbols-rounded">edit_square</span> Edit Author</h1>
            <nav>
        ...
        <main>
            <form:form action="/authors/edit/${author.id}" method="post" modelAttribute="author" class="form">
